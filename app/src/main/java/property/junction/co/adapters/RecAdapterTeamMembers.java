...
public class RecAdapterTeamMembers extends RecyclerView.Adapter<RecAdapterTeamMembers.MyViewHolder> {

    Context context;
    ArrayList<HashMap<String,Object>> list = new ArrayList<>();

    public RecAdapterTeamMembers(Context context, ArrayList<HashMap<String,Object>> list) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_team_member, parent, false);
